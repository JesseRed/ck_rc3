function N = ck_rc3_estimate_C2C_network_groups_statistic3(outdir,unc,...
...
N.name = sprintf('2s intra Netzwerk ttest %i vs %i; p = %g',size(data.Z1,3),size(data.Z2,3),unc);
